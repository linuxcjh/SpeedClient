package co.mbiwise.materialintro.view;
...
import co.mbiwise.materialintro.MaterialIntroConfiguration;
import co.mbiwise.materialintro.R;
import co.mbiwise.materialintro.animation.AnimationFactory;
import co.mbiwise.materialintro.animation.AnimationListener;
import co.mbiwise.materialintro.animation.MaterialIntroListener;
import co.mbiwise.materialintro.prefs.PreferencesManager;
import co.mbiwise.materialintro.shape.Circle;
import co.mbiwise.materialintro.shape.Focus;
import co.mbiwise.materialintro.shape.FocusGravity;
import co.mbiwise.materialintro.shape.Rect;
import co.mbiwise.materialintro.shape.Shape;
import co.mbiwise.materialintro.shape.ShapeType;
import co.mbiwise.materialintro.target.Target;
import co.mbiwise.materialintro.target.ViewTarget;
import co.mbiwise.materialintro.utils.Constants;
import co.mbiwise.materialintro.utils.Utils;
