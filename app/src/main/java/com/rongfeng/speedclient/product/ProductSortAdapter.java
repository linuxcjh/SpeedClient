...
public class ProductSortAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public ProductSortAdapter(Context mContext, List<SortModel> list, Handler handler) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.product_item_layout, null);
