 ...
 * 最多三个子View
 */
public class EffectsCalendarView extends FrameLayout implements View.OnClickListener {
    ...
    public EffectsCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        ...
        childView1 = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.effects_calendar_chlid_layout, null);
        LayoutParams lp1 = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        childView1.setLayoutParams(lp1);
        addView(childView1);
        weekView = (WeekView) childView1.findViewById(R.id.weekView);
        listView = (ListView) childView1.findViewById(R.id.listView);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, sizeHeight - calendarViewTopHeight - lineHeight);
        listView.setLayoutParams(lp);
        new JudgeChildScrollTop(listView, handler);
        cH = calendarHeight;
