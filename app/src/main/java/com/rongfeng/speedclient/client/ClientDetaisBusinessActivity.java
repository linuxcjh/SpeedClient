 ...
 * 添加商机
 */
public class ClientDetaisBusinessActivity extends BaseActivity {
...
//        }
    ...
    private void invoke() {
        ...
        commonPresenter.invokeInterfaceObtainData(XxbService.UPDATECSRBUSINESS, transModel, new TypeToken<BaseDataModel>() {
        });
    }
