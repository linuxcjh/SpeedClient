 ...
 * 选择对话框
 */
public class SelectionVoiceDialog extends Dialog implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public SelectionVoiceDialog(Context context, int layoutResId, Handler handler, int selectSign) {
        this(context, layoutResId, handler, selectSign, 0);
    }

    public SelectionVoiceDialog(Context context, int layoutResId, Handler handler, int selectSign, int height) {
     ...
     * @param str
     */
    public SelectionVoiceDialog setTitle(String str) {
     ...
     * @param str
     */
    public SelectionVoiceDialog setCancelTitle(String str) {
        TextView cancel = (TextView) findViewById(R.id.cancel);//取消
     ...
     * @param adapter
     */
    public SelectionVoiceDialog setAdapter(BaseQuickAdapter adapter) {
    ...
    public SelectionVoiceDialog buildDialog() {
        super.show();
