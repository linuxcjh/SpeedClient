 ...
 */
public class ManageBusinessAdapter extends BaseRecyclerAdapter<ManageFollowModel> {


    public ManageBusinessAdapter(Context context, int layoutResId, List<ManageFollowModel> data) {
